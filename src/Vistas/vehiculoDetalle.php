...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 lower-box box-primary">
            <h3>Vehiculo de <?php $titular = $vehiculo->getTitular();
                echo $titular->getNombre() . ' ' . $titular->getApellido(); ?></h3>
            <hr>
            <div class="row">
                <div class="col-xs-3">
                    <img
                        src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?= $vehiculo->getDominio(); ?>&choe=UTF-8"
                        title="Vehiculo" class="img-responsive"/>
                </div>
                <div class="col-xs-9">
                    ...
                    <?php if ($_SESSION["rol"] === 'titular') { ?>
                        <a class="btn btn-primary pull-right" href="/consulta/usuarioVehiculos/" role="button">Volver</a>
                    <?php } ?>
                </div>
            </div>
        </div>
