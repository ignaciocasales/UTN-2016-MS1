    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            if ($_SESSION["rol"] === 'developer') {
                ?>
                <a class="btn btn-primary pull-right" href="<?= '/consulta/vehiculos/' ?>" role="button">
            ...
            if ($_SESSION["rol"] === 'titular') {
                ?>
                <a class="btn btn-primary pull-right" href="<?= '/consulta/vehiculo/' ?>" role="button">
                    <span class="glyphicon glyphicon-arrow-left"></span>
                    Volver
                </a>
                <?php
                    ...
                    if ($listadoMovimientos) {
                        foreach ($listadoMovimientos as $objeto) { ?>
                            ...
                            ?>">
                                ...
                                <td>
                                    <?= $objeto->getFechaYhora(); ?>
                                </td>
                                <td>
                                    &dollar;<?= $objeto->getImporte(); ?>
                                </td>
                            </tr>
                            <?php
                        }
